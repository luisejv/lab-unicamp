              ...
              <Row>
                <Col className="colF" xs={12}>
                  ...
                  <div className="peopleDescription">
                    ...
                    received the M.Sc. degree in electrical engineering and the
                    M.Sc. in informatics, from the Pontifical Catholic
                    University of Rio de Janeiro, Rio de Janeiro, Brazil, in
                    1985 and 1987, respectively, and the Ph.D. degree in physics
                    from the Imperial College of Science, Technology and
                    Medicine, London, UK, in 1992. <br></br>After spending two
                    years as a Postdoctoral Fellow with the Department of
                    Electronic and Electrical Engineering, UCL, London, UK, he
                    joined the UNICAMP, FEEC, as an Assistant Professor in 1995.{' '}
                    <br></br>
                    <br></br>
                    ...
                    (Opto-Electronics/Integrated Optics) of the IEEE/OSA Journal
                    of Lightwave Technology (January 2004 – December 2009).
                    <br></br> He is a Fellow of the OSA class 2011, was a
                    recipient of the IEEE Third Millennium Medal in 2000, and
                    also, the recipient of the Attilio Giarola’s Medal in 2013,
                    for outstanding research achievements from the SBMO. He has
                    acted as area coordinator of engineering at the Brazilian
                    Agency FAPESP since 2014.
            ...
            <Col md={12} lg={4}>
              <Row>
                <Col className="colF2" xs={12}>
                  <Image className="peopleImage" src={person.src} fluid />
